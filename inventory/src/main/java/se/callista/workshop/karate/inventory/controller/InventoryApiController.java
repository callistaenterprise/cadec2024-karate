...
public class InventoryApiController {
    ...
    public ResponseEntity<InventoryValue> getInventory(@PathVariable("articleId") String articleId) {
        try {
            InventoryValue inventory = inventoryService.getInventory(articleId);
